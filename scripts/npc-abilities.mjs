 ...
 * (Vulnerable incomingAttacksModifier → Favor on cast checks) and adds
 * cone-animation support to VagabondItemSequencer.
 */
...
async function _wrapSystemClasses() {
  ...
  // ── 5. Patch VagabondItemSequencer to support cone animations ─────────────
